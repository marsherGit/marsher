...
<form id="updateForm" method="post" name="updateForm" action="AdminUpdatePro.do?st_id=${st_id}" onsubmit="return checkIt()">
		...
		<div class="col-sm-6">
			<ul class="list-group row">
				...
				<div class="col-sm-9 padding4em">
				<div class="col-sm-10 nopadding"><input id="st_location" name="st_location" value="${member.st_location}" class="st_location form-control"/></div>
				<div class="col-sm-2 nopadding">
						<input type="button" class="btn btn-info" value="위치검색" onClick="#, searchPlaces(); return false;" data-toggle="modal"
