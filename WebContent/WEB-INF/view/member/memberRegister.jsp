...
<body>
	...
	<form method="post" name="infoForm" action="registerPro.do"
			...
			<div class="container text-left"
				...
				<div class="row">
					<div class="col-sm-4" id='View_area'
						...
						<label for="st_image">이미지 업로드</label> <img style='cursor: hand'
							src="/Marsher/images/test.png" align="absMiddle" border="0"
							width="300" height="250" onclick="fncProductFile()"
							id="UploadedImg"> <input type="file" id="st_image"
							name="st_image"
					...
					<div style='width: 500px;' class="col-sm-4">
						<table class="table table-bordered">
							<tr>
								<td>매장아이디</td>
								<td><input type="text" id="st_id" name="st_id"
									style="width: 70px; height: 18px"></td>
							</tr>
							<tr>
								<td>비밀번호</td>
								<td><input type="password" id="passwd" name="passwd"
									style="width: 80px; height: 18px" maxlength="6"></td>
							</tr>
							<tr>
								<td>비밀번호 확인</td>
							...
							<tr>
								...
								<td><input type="text" id="st_name" name="st_name"
									colsapn="3" style="width: 100px; height: 18px"></td>
							</tr>
							<tr>
								<td>연락처</td>
								<td><input type="text" style="width: 80px; height: 18px"
									name="st_tel"></td>
							</tr>
							<tr>
								<td>주소</td>
							...
							<tr>
								<td>사인 등록</td>
								<td><input type="file" id="sign_img" name="sign_img"
									class="upload-hidden" onchange="checkfile2()"></td>
							</tr>
						</table>
