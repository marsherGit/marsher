...
$(document).ready(function(){
	$("#select1").change(function(){
		...
		var url="<%=cp%>/chowonheeView/ajax/StjegoJJ1";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" name="adjustButton" id="adjustButton" value="조정하기" class="btn btn-default" class="btn btn-default"/>
<input type="button" name="cancelButton" id="cancelButton" value="취소하기" class="btn btn-default" onclick="document.location.href='StjegoJJ'"/>
</center>
</form>
</c:if>
</body>
