...
<table border="1" cellpadding="0" cellspacing="0" align="center" border="1" class="table-striped">
  ...
  <c:set var="number" value="${number - 1}"/>
    ...
    <td align="center" width="100px" id="remark" ><input type="text" style="text-align:center; width:90px;" id="pro_remark" name="pro_remark" class="pro_remark btn btn-default" value="${article.pro_remark}" readonly/></td>
  </tr>
  </c:forEach>
