...
public class ProductPlusRemark {
	...
	int totalStockAmount; /* 창고재고수량  */
	int totalStockAmountStore; /* 매장재고수량 */
	
	public int getTotalStockAmountStore() {
		return totalStockAmountStore;
	}
	public void setTotalStockAmountStore(int totalStockAmountStore) {
		this.totalStockAmountStore = totalStockAmountStore;
	}
	public int getTotalStockAmount() {
		return totalStockAmount;
	}
	public void setTotalStockAmount(int totalStockAmount) {
